...
#define FSGUI_NEWFLTDLG_VISIBILITY                        FsGetTextResource("newfltdlg/visibility",L"Visibility(nautical mile)")
...
#define FSGUI_CFGDLG_VISIBILITY                           FsGetTextResource("configdlg/visibility",L"Visibility (nautical mile)")
